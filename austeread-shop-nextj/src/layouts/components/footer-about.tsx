...
export default function FooterAbout() {
  ...
  return (
    <>
      <button type="button" onClick={(e) => setIsOpen(true)} className="text-left cursor-pointer hover:bg-white/20 rounded p-2">
        About
      </button>
      <FooterModal open={isOpen} setIsOpen={setIsOpen}>
        <div className="flex gap-3 sm:gap-10  sm:flex-row">
          <div className="image mx-auto !w-[170px]">
            <Image width={200} height={300} className="!w-full" src="https://article.austeread.com/assets/austeread/sdpk-1-min.png" alt="sdpk-1-min.png" />
          </div>
          <div className="w-2/3">
            <h2 className="text-light font-PublicSansBlack sm:text-[40px]">About Us</h2>
