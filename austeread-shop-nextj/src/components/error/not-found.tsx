    ...
    <div className="sm:bg-gray-200 py-10 sm:min-h-[70vh] flex items-center">
      <div className="bg-white mx-auto max-w-4xl flex gap-4 flex-col sm:flex-row space-y-7 p-2 py-10">
        <div className="header">
          <Image width={100} height={100} style={{ width: "auto", height: "auto" }} src="/image/not-found.png" alt="" className="!h-[339px] !w-full" />
        </div>
        <div>
          ...
          <div className="footer">
            <div className="action flex justify-between gap-3 sm:py-5">
              <Link href={"/"} className="w-1/2 whitespace-nowrap py-3 text-sm border-2 border-dark font-garnet font-normal flex justify-center">
                GO TO HOME PAGE
              </Link>
